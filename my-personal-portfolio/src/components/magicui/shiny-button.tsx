...
const ShinyButton = ({
  ...
  return (
    ...
    >
      <span
        className="relative block h-full w-full text-sm tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)] font-[family-name:var(--font-geist-sans)]"
        style={{
          maskImage:
